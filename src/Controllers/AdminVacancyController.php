    ...
    public function index(): string
    {
        ...
        foreach ($vacancies as $v) {
            ...
            <tr>
              ...
              <td>{$type}</td>
              <td class='td-actions'>
                <a class='btn btn--sm btn--ghost' href='/admin/vacatures/edit/{$v->id}'>✏️</a>
                <a class='btn btn--sm btn--danger' href='/admin/vacatures/delete/{$v->id}' onclick='return confirm(\"Vacature verwijderen?\")'>🗑️</a>
              </td>
            </tr>";
        }
...
<section class="page-wrapper">
  ...
  <div class="admin-panel" style="margin-top:20px">
    <h3 class="admin-panel__title">Nieuwe vacature</h3>
    ...
    <form method="post" action="/admin/vacatures/store" class="form">
      ...
      <label>Type</label>
      <input name="type" placeholder="Fulltime / Parttime" required>
...
<section class="page-wrapper">
  ...
  <div class="admin-panel">
    <form method="post" action="/admin/vacatures/update/{$v->id}" class="form">
      ...
      <button class="btn btn--primary" style="margin-top:12px">Opslaan</button>
      <a class="btn btn--ghost" style="margin-top:12px" href="/admin/vacatures">Annuleren</a>
    </form>
  </div>
</section>
HTML;
